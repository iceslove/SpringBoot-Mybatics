...
$(document).ready(function(){
    var cols = [
        ...
        {data:'roleId',name:'s_role_id',orderable:true,searchable:true,visible:false,render:function(val){
            return val} },
        {data:'roleName',name:'s_role_name',orderable:true,searchable:true,visible:true,render:function(val){
            return val} },
        {data:'roleDesc',name:'s_role_desc',orderable:true,searchable:true,render:function(val){
            return val}},
...
function GridClickFunction_Edit(item){
    ...
    var url = "/admin/role/edit/"+roleId;
    $.ajax({
        type: "GET",
        url: url,
        dataType: 'html',
...
function GridClickFunction_Delete(item){
    ...
    WX.Confirm('确定要删除么？',function(){
        var url = "/admin/role/delete/"+roleId;
...
function GridClickFunction_Menu(item){
    var roleId = item.roleId;
    var url = '/admin/role/selectMenus/'+roleId ;
    $.ajax({
        type: "GET",
        url: url,
        dataType: 'html',
